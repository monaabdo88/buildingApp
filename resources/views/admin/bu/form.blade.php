...
<div class="form-group{{ $errors->has('bu_name') ? ' has-error' : '' }}">
    <label for="bu_name" class="col-md-2 control-label">أسم العقار</label>
...
<div class="form-group{{ $errors->has('rooms_num') ? ' has-error' : '' }}">
    <label for="rooms_num" class="col-md-2 control-label"> عدد الغرف</label>
    <div class="col-md-6 col-md-offset-2">
        {!! Form::text('rooms_num',null,['class'=>'form-control']) !!}
...
<div class="form-group{{ $errors->has('bath_num') ? ' has-error' : '' }}">
    <label for="bath_num" class="col-md-2 control-label"> عدد الحمامات</label>
    <div class="col-md-6 col-md-offset-2">
...
<div class="form-group{{ $errors->has('bu_rent') ? ' has-error' : '' }}">
    <label for="bu_rent" class="col-md-2 control-label">نوع الملكية</label>
    <div class="col-md-6 col-md-offset-2">
...
<div class="form-group{{ $errors->has('bu_type') ? ' has-error' : '' }}">
    <label for="bu_type" class="col-md-2 control-label">نوع العقار</label>
    <div class="col-md-6 col-md-offset-2">
...
<div class="form-group{{ $errors->has('bu_meta') ? ' has-error' : '' }}">
    <label for="bu_meta" class="col-md-2 control-label">الكلمات الدلالية</label>
    <div class="col-md-6 col-md-offset-2">
...
<div class="form-group{{ $errors->has('bu_small_disc') ? ' has-error' : '' }}">
    <label for="bu_small_disc" class="col-md-2 control-label"> وصف العقار لمحركات البحث</label>
    <div class="col-md-6 col-md-offset-2">
...
<div class="form-group{{ $errors->has('bu_langtuide') ? ' has-error' : '' }}">
    <label for="bu_langtuide" class="col-md-2 control-label">خط الطول</label>
    <div class="col-md-6 col-md-offset-2">
...
<div class="form-group{{ $errors->has('bu_latituide') ? ' has-error' : '' }}">
    <label for="bu_latituide" class="col-md-2 control-label"> دائرة العرض</label>
    <div class="col-md-6 col-md-offset-2">
...
<div class="form-group{{ $errors->has('bu_large_disc') ? ' has-error' : '' }}">
    <label for="bu_large_disc" class="col-md-2 control-label">  وصف العقار</label>
    <div class="col-md-6 col-md-offset-2">
...
<div class="form-group{{ $errors->has('image') ? 'has-error':'' }}">
    <label class="col-md-2 control-label" for="image">صورة العقار</label>
    <div class="col-md-6 col-md-offset-2">
